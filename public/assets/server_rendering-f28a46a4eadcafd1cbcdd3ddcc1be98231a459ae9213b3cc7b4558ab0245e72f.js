...
var Main = function (props) {
  return React.createElement(
    "div",
    null,
    React.createElement(TimeContainer, null)
  );
};
...
var TimeContainer = (function (_React$Component) {
  ...
  function TimeContainer() {
    ...
    _get(Object.getPrototypeOf(TimeContainer.prototype), "constructor", this).call(this);
    var d = new Date();
    this.state = {
      day: d.getDay(),
      month: d.getMonth(),
  ...
  _createClass(TimeContainer, [{
    ...
    value: function render() {
      var months = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "November", "Dec"];
